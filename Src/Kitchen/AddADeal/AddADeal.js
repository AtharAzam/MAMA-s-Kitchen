...
export default class AddADeal extends Component {
  constructor() {
    super();
    this.state = {
      foodName: '',
          ...
          <KeyboardAwareScrollView style={styles.container}>
            <View>
              <View style={{marginBottom: 10, alignItems: 'center'}}>
                <Text style={styles.createADealStyle}>Create a deal</Text>
              </View>
              <View>
                <TextInput
                  autoCapitalize="none"
              ...
              <View>
                <TextInput
                  ...
                  style={styles.inputFiledStyle}
                  autoCorrect={false}
                  value={this.state.preparedFoodSelection}
                  placeholder="Select Prepared Food"
                  onChangeText={(preparedFoodSelection) =>
                    this.setState(preparedFoodSelection)
                  }
                />
              </View>
